	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("INR", 80.00);
				break;
			case "Euro":
				...
				this.exchangeValues.put("INR", 90.00);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("INR", 105.00);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 94.00);
				break;
